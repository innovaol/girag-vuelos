...
def generate_document_filename(instance, filename):
    """
    Genera un nombre de archivo usando el número de vuelo y la fecha/hora actual en la zona horaria de Panamá.
    El formato es: "documents/{flight_number}-{YYYYMMDD}_{HHMMSS}{ext}"
    Por ejemplo: "documents/12B1514-20250417_220156.png"
    """
    ...
    return f"documents/{flight_number}-{date_str}_{time_str}{ext}"
